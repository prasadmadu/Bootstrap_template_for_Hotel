...
<div  class="row">
            ...
            <div  class="col-sm-3" id="">
                ...
                <input type="password" class="form-control" id="" name="" placeholder="Last Name">
                <br>
            </div>
            <div  class="col-sm-3" id="">
                <br>
...
<!--*******************************************************************-->
        <div  class="row">
            ...
            <div  class="col-sm-5" id="">
                <label for="">Alt Telephone No:</label>
                <input type="text" class="form-control" id="" name="" placeholder="Telephone Number">
                <br>
            </div>
            <div  class="col-sm-1" id="formboder"></div>
...
<!--*******************************************************************-->
        <div  class="row">
            ...
            <div  class="col-sm-10" id="">
                <button type="submit" class="form-control submitbutton">Register as a Guide</button>
                <br>
                <br>
            </div>
            <div  class="col-sm-1" id="formboder"></div>
