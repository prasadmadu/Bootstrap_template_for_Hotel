...
<!--*******************************************************************-->
        <div  class="row">
            ...
            <div  class="col-sm-3" id="">
                ...
                <input type="email" class="form-control" id="" name="" placeholder="E-mail Address">
                <br>
            </div>
            <div  class="col-sm-3" id="">
                <label for="">Telephone No:</label>
                <input type="number" class="form-control" id="" name="" placeholder="Telephone Number">
                <br>
            </div>
            <div  class="col-sm-4" id="">
                <label for="">NIC No:</label>
                <input type="text" class="form-control" id="" name="" placeholder="Telephone Number">
                <br>
            </div>
            <div  class="col-sm-1" id="formboder"></div>
        </div>
<!--*******************************************************************-->
        <div  class="row">
            ...
            <div  class="col-sm-10" id="">
                ...
                <textarea name="message" rows="10" class="form-control" width="100%">
                    Working Experience
                </textarea> 
            </div>
            <div  class="col-sm-1" id="formboder"></div>
...
<!--*******************************************************************-->
        <div  class="row">
            <div  class="col-sm-1" id="formboder"></div>
            <div  class="col-sm-10" id="">
                <button type="submit" class="form-control submitbutton">Submit Details</button>
                <br>
                <br>
            </div>
            <div  class="col-sm-1" id="formboder"></div>
