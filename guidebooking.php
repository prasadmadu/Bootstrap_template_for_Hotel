...
<!--*******************************************************************--> 
    <div class="row" id="rr1">
        ...
        <div class="col-sm-2"><img src="images/room_4.jpg" alt="" width="100%"></div>

        
        <div class="col-sm-3">
            <br>
            <h3 id="roomdesh">madusanka prasad</h3>
            <h5 id="roomdesh">ncprasadmadusanka@gmail.com</h5>

        </div>
        <div class="col-sm-3" id="">
            <br>
            <span id="rate">2019.09.27</span>

        </div>
        <div class="col-sm-2" id="roomdes">
            <br>
            <h4 id="roomdesh">011-5864521</h4>
            <h4 id="roomdesh">011-5864521</h4>
        </div>
        <div class="col-sm-1" id="rre"></div>
    </div>
