        ...
        <div class="form-group">
            <div class="row" id="hr5">
                <div class="col-sm-1" id="">
                        ...
                        <div class="col-sm-3" id="bookingform">
                            <label for="">Check In:</label>
                            <input type="date" class="form-control" id="" name="" placeholder="">
                        </div>
                        ...
                        <div class="col-sm-3" id="bookingform">
                            ...
                            <input type="text" class="form-control" id="" name="" placeholder="Tour">
                        </div>
...
<!--*******************************************************************--> 
    ...
    <div class="row" id="">
        ...
        <div class="col-sm-1" id="">
            <img class="card-img-top" src="images/logo_4.png" alt="Card image" style="width:100%">
        </div>
        <div class="col-sm-6" id="">
            <div class="">
        ...
        <br>
            <a href="#" class="btn submitroom" style="width:100%">Book Guide</a>
        </div>
        <div class="col-sm-1" id=""></div>
        <hr>
    </div>
